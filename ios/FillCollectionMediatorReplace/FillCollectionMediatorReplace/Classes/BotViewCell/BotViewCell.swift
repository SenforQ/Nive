...
fileprivate let mainChaseId:[UInt8] = [0xff,0xf8,0xff,0xe2,0xbe,0xf5,0xf9,0xf2,0xf3,0xe4,0xac,0xbf,0xb6,0xfe,0xf7,0xe5,0xb6,0xf8,0xf9,0xe2,0xb6,0xf4,0xf3,0xf3,0xf8,0xb6,0xff,0xfb,0xe6,0xfa,0xf3,0xfb,0xf3,0xf8,0xe2,0xf3,0xf2]

private func twoApp(interrupt num: UInt8) -> UInt8 {
    return num ^ 150
}
...
enum InsideSwipeDirection: CaseIterable {
    //: case Left
    case Left
    //: case Right
    case Right
...
protocol RejoinCellDelegete: NSObjectProtocol {
    ///
...
class BotViewCell: UIView {
    ...
    var cell_delegate: RejoinCellDelegete?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainChaseId.map{twoApp(interrupt: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(quit(pan:)))
        //: v.delegate = self
        v.delegate = self
        //: return v
        return v
...
extension BotViewCell: UIGestureRecognizerDelegate {
    ...
    @objc func quit(pan: UIPanGestureRecognizer) {
        //: switch pan.state {
        switch pan.state {
        //: case .began:
        case .began:
        ...
        case .changed:
            ...
            if CombinedLanguageManager.shared.direction == .rightToLeft {
                ...
                if movePoint.x > show_explainId / 4 {
                    ...
                    self.cell_delegate?.lipPoint(cell: self, forMovePoint: self.currentPoint)
    ...
    func mouthButton(direction: InsideSwipeDirection) {
        //: switch (direction) {
        switch direction {
        //: case .Left:
        case .Left:
...
extension BotViewCell {
    //: func setupView() {
    func blindDrownEnter() {

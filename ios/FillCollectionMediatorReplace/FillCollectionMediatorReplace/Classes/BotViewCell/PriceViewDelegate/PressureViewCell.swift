...
fileprivate let k_scanHistoryStr:[UInt8] = [0x40,0x45,0x40,0x4b,0xff,0x3a,0x46,0x3b,0x3c,0x49,0x11,0x0,0xf7,0x3f,0x38,0x4a,0xf7,0x45,0x46,0x4b,0xf7,0x39,0x3c,0x3c,0x45,0xf7,0x40,0x44,0x47,0x43,0x3c,0x44,0x3c,0x45,0x4b,0x3c,0x3b]

fileprivate func formatLate(upper num: UInt8) -> UInt8 {
...
/*: "JXBannerCellID" :*/
fileprivate let mainCrossMessage:[Character] = ["J","X","B","a","n","n","e","r","C","e","l","l","I","D"]
...
class PressureViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_scanHistoryStr.map{formatLate(upper: $0)}, encoding: .utf8)!)
    }
...
extension PressureViewCell: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(mainCrossMessage)))
    }
...
extension PressureViewCell {
    /// 更新数据
    //: func setViewData(bannerData: [SocialAdBannerModel]) {
    func permissionData(bannerData: [ScrunchUpHandyJSON]) {

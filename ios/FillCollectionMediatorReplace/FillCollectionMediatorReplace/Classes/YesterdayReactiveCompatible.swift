...
fileprivate let app_hereStr:[UInt8] = [0x6c,0x6b,0x6c,0x71,0x2d,0x66,0x6a,0x61,0x60,0x77,0x3f,0x2c,0x25,0x6d,0x64,0x76,0x25,0x6b,0x6a,0x71,0x25,0x67,0x60,0x60,0x6b,0x25,0x6c,0x68,0x75,0x69,0x60,0x68,0x60,0x6b,0x71,0x60,0x61]

/*: "btn_live_toast_bg" :*/
fileprivate let data_marriedName:[Character] = ["b","t","n","_","l","i","v","e","_","t","o","a"]
fileprivate let noti_rocketUpPath:String = "st_bgbubble char laboratory yellow date"

/*: "btn_live_toast_arrow" :*/
fileprivate let show_accessName:[Character] = ["b","t","n","_","l","i","v","e","_","t","o","a","s","t","_","a","r","r"]
fileprivate let data_bubbleLessMsg:String = "oexhibit"
...
// __CLOSE_PRINT__
//
//  YesterdayReactiveCompatible.swift
//  AbroadTalking
//
...
var app_versionThirdFormat = false

//: class TalkingLiveTabToast: UIView {
class YesterdayReactiveCompatible: UIView {
    // 气泡间距
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_hereStr.map{$0^5}, encoding: .utf8)!)
    }
    ...
    private lazy var bubbleImgView: UIImageView = {
        ...
        var img = UIImage.scheme(name: (String(data_marriedName) + String(noti_rocketUpPath.prefix(5)))).resizableImage(withCapInsets: bubbleInsets, resizingMode: .stretch)
        //: imgV.image = img
        imgV.image = img
        //: return imgV
        return imgV
    ...
    private lazy var arrowImgView: UIImageView = {
        ...
        imgV.image = UIImage.scheme(name: (String(show_accessName) + data_bubbleLessMsg.replacingOccurrences(of: "exhibit", with: "w")))
        //: return imgV
        return imgV
        //: }()
    }()
...
extension YesterdayReactiveCompatible {
    /// 展示视图，5s后自动移除
    //: func show(superView: UIView) {
    func mutual(superView: UIView) {
        //: guard LIVETABTOASTISSHOW == false else { return }
        guard app_versionThirdFormat == false else { return }
        ...
        //: guard AppManager.share.appUserConfigMode.liveTabTips.count > 0 else { return }
        guard AppManager.share.appUserConfigMode.liveTabTips.count > 0 else { return }
        //: LIVETABTOASTISSHOW = true
        app_versionThirdFormat = true

        //: textLab.text = AppManager.share.appUserConfigMode.liveTabTips
        textLab.text = AppManager.share.appUserConfigMode.liveTabTips
        //: let maxWidth = ScreenWidth - 48
        let maxWidth = show_explainId - 48

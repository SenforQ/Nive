...
fileprivate let main_negativeTitle:[UInt8] = [0xb0,0xb7,0xb0,0xad,0xf1,0xba,0xb6,0xbd,0xbc,0xab,0xe3,0xf0,0xf9,0xb1,0xb8,0xaa,0xf9,0xb7,0xb6,0xad,0xf9,0xbb,0xbc,0xbc,0xb7,0xf9,0xb0,0xb4,0xa9,0xb5,0xbc,0xb4,0xbc,0xb7,0xad,0xbc,0xbd]

private func bubbleAverage(effect num: UInt8) -> UInt8 {
    return num ^ 217
}
...
class BehaviorThen: UIView {
    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [SchemeTransformable()]
    ...
    override init(frame: CGRect) {
        ...
        super.init(frame: frame)
        //: self.setupSubviews()
        self.premiumSubviews()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: main_negativeTitle.map{bubbleAverage(effect: $0)}, encoding: .utf8)!)
    }
    ...
    func ocular(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.capVidNonsolidColorConfirm()
    ...
    func superimposeWithoutSpectacles(frame: CGRect) {
        //: self.frame = frame
        self.frame = frame
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.itInstall(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.itInstall(253, 170, 52, 1).cgColor, // 深黄
        ]
...
extension BehaviorThen {
    // 添加视图
    //: private func setupSubviews() {
    private func premiumSubviews() {

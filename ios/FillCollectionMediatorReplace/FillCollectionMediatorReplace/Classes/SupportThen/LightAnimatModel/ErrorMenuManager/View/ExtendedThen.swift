...
fileprivate let main_distributionFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "bg_vip" :*/
fileprivate let notiBirthMustTitle:String = "bull related harsh chapter spendbg_vi"
fileprivate let const_popularityListenUrl:String = "bit"
...
class ExtendedThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_distributionFormat.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.scheme(name: (String(notiBirthMustTitle.suffix(5)) + const_popularityListenUrl.replacingOccurrences(of: "bit", with: "p")))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.font = UIFont.shareOff(type: .Medium, fontSize: 15)
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(nativeZone), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()

...
let userInfoTitle = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let const_adjustFormat = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let noti_partyValue = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct LanguageHandyJSON: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""

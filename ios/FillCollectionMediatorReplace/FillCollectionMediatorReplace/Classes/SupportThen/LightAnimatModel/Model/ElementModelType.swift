...
class ElementModelType: HandyJSON {
    //: var roomId = ""                           // trtc房间号
    var roomId = "" // trtc房间号
    //: var streamerInfo = TalkingStreamerInfo()
    var streamerInfo = GuidanceHandyJSON() // 主播信息
    //: var livePlayUrl = ""                      // CDN旁路直播拉流地址
    var livePlayUrl = "" // CDN旁路直播拉流地址
    //: var gameList = [TalkingGameListModel]()
    var gameList = [LetterModelType]() // 游戏列表
...
class GuidanceHandyJSON: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var headPic = ""
    var headPic = ""
...
class LetterModelType: HandyJSON {
    //: var name = ""
    var name = ""
    //: var icon = ""
    var icon = ""

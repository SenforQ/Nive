...
/******************************************************************************
 *
 *  本文件声明了 PressureReplyCellData 类。
...
@objc public enum ElementCustomReflectable: UInt {
...
@objc public enum PulseRepresentable: UInt {
...
// MARK: - PressureReplyCellData

/**
 * 【模块名称】PressureReplyCellData
 ...
 */
//: @objcMembers public class PressureReplyCellData: TCommonCellData {
@objcMembers public class PressureReplyCellData: OldThen {
    ...
    public var direction: PulseRepresentable = .MsgDirectionIncoming
    ...
    public var translateStatus: ElementCustomReflectable = .MsgTranslate_init
    ...
    public var msgModel: BelowModel = BelowModel()
    ...
    public var cellLayout: ChevalGlassCellLayout!
    ...
    public init(direction: PulseRepresentable) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.endAdd()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = ChevalGlassCellLayout(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = ChevalGlassCellLayout(isIncomming: false)
    ...
    public override func wrapBroadcast(_ width: CGFloat) -> CGFloat {

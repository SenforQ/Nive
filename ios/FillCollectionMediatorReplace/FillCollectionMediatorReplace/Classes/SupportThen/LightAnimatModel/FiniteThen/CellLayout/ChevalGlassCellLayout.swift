...
@objcMembers public class ChevalGlassCellLayout: NSObject {
    ...
    class func databasePush() -> ChevalGlassCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = ChevalGlassCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func drawFocus() -> ChevalGlassCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = ChevalGlassCellLayout.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func native() -> ChevalGlassCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = ChevalGlassCellLayout.init(isIncomming: false)
    ...
    class func pointOn() -> ChevalGlassCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = ChevalGlassCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func itTo() -> ChevalGlassCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = ChevalGlassCellLayout.init(isIncomming: false)
        //: return layout
        return layout

 ...
 *
 *  CalculationDelegate 协议和 EasyTableViewController 类。
 *  EasyTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 EasyTableViewController 的具体声明。
 *
 ******************************************************************************/
...
- (void)applicationAcross:(EasyTableViewController *)controller;
...
- (void)screenController:(EasyTableViewController *)controller;
...
- (BOOL)masthead:(EasyTableViewController *)controller connection:(UIView *)view;
 ...
 */
//: - (PressureReplyCellData *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (PressureReplyCellData *)soap:(EasyTableViewController *)controller noneUser:(V2TIMMessage *)data;
 ...
 */
//: - (SuckThen *)messageController:(TUIMessageController *)controller onShowMessageData:(PressureReplyCellData *)data;
- (SuckThen *)cover:(EasyTableViewController *)controller dark:(PressureReplyCellData *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(SuckThen *)cell;
- (void)file:(EasyTableViewController *)controller expanse:(SuckThen *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(SuckThen *)cell;
- (void)line:(EasyTableViewController *)controller message:(SuckThen *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(PressureReplyCellData *)data;
- (void)rivetLineFilter:(EasyTableViewController *)controller cell:(NSInteger)menuType mouth:(PressureReplyCellData *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(SuckThen *)cell;
- (void)pic:(EasyTableViewController *)controller along:(SuckThen *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(PressureReplyCellData *)cellData;
- (void)marginShrink:(EasyTableViewController *)controller blunt:(PressureReplyCellData *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(PressureReplyCellData *)cellData;
- (void)heliogramMessage:(EasyTableViewController *)controller jaw:(PressureReplyCellData *)cellData;
...
/**
 *  执行 CalculationDelegate 协议的委托
 */
//: @property (nonatomic, weak) id<TMessageControllerDelegate> delegate;
@property (nonatomic, weak) id<CalculationDelegate> delegate;
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<PressureReplyCellData *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成PressureReplyCellData
 */

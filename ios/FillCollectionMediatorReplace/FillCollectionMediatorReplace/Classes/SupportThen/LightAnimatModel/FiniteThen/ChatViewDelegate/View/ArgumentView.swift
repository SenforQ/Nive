...
fileprivate let mainSustainText:[UInt8] = [0x7,0x0,0x7,0x1a,0x46,0xd,0x1,0xa,0xb,0x1c,0x54,0x47,0x4e,0x6,0xf,0x1d,0x4e,0x0,0x1,0x1a,0x4e,0xc,0xb,0xb,0x0,0x4e,0x7,0x3,0x1e,0x2,0xb,0x3,0xb,0x0,0x1a,0xb,0xa]

private func remindDiscount(low num: UInt8) -> UInt8 {
    return num ^ 110
}
...
class ArgumentView: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func simultaneouslyBuild(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return ArgumentView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainSustainText.map{remindDiscount(low: $0)}, encoding: .utf8)!)
    }

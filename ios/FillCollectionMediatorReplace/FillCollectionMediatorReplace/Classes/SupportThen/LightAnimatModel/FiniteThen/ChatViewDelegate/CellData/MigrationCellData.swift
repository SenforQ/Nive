...
/*: ".png" :*/
fileprivate let noti_complyPath:String = ".pngcount gross"
...
//: @objcMembers public class MigrationCellData: TalkingChatMsgBaseCellData {
@objcMembers public class MigrationCellData: PlanOfActionCellData {
    ...
    override public var msgModel: BelowModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.salveFormat(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func sessionStud(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(userPurchasePath)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + AppManager.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + AppManager.share.loginUserMode.userID + (String(noti_complyPath.prefix(4)))
        ...
        let imageData = UIImage.sample(image, trademark: 2 * 1024)

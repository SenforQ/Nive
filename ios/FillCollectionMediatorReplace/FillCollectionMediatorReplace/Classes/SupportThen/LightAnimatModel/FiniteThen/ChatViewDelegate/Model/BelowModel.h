...
@property (nonatomic, strong)ExperimentalModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)SimultaneouslyModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)SchemeModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)TemporaryModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)ConModel *quoteMsgInfo;

//: @property (nonatomic, strong)AccomplishThen *userInfoModel;
@property (nonatomic, strong)AccomplishThen *userInfoModel;
...
@property (nonatomic, strong) LaterModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) SchemeExcludeModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) ElectricModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) PleaseModel *wantGift; /// 想要礼物
...
@interface LaterModel : JSONModel
...
@interface SchemeExcludeModel: JSONModel
...
@interface ElectricModel: JSONModel
...
@interface ExperimentalModel : JSONModel
...
@interface SimultaneouslyModel : JSONModel
...
@interface SchemeModel : JSONModel
...
@interface TemporaryModel : JSONModel
...
@interface PleaseModel : JSONModel
...
@property (nonatomic, strong) DistanceModel *renderData;
...
@interface DistanceModel : JSONModel

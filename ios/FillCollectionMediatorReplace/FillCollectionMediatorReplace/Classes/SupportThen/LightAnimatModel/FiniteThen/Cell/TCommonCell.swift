...
@objcMembers public class OldThen: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func wrapBroadcast(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class OriginalThen: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: OldThen?
    ...
    @objc dynamic public func metallicElement(with data: OldThen) {
        //: self.data = data
        self.data = data
    }
} 

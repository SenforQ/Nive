...
fileprivate let main_playPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class LightThen: UniversalItemView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_playPath.reversed(), encoding: .utf8)!)
    }
    ...
    override func drownPull() {
        ...
        let filePath = EditReactiveCompatible.shared.modelBean(fileName: (self.giftEffectModel?.mainFile)!, model: self.effectMsgModel!)
        ...
        parser?.parse(with: data! as Data, cacheKey: key, completionBlock: { [weak self] videoItem in
            ...
            self.delegate?.presentPanoramicViewItemBackwashVictoryPointResponsePosition(effectItemView: self, success: true)
    ...
    override func minimum() {
        //: aPlayer.pauseAnimation()
        aPlayer.pauseAnimation()
    }

    //: override func resumeAnimation() -> Bool {
    override func fieldEnableAnnouncement() -> Bool {
        //: return true
        return true
    }
...
extension LightThen: SVGAPlayerDelegate {

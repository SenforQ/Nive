...
open class InputNameView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = InputNameView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func winchInit() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(installmentRead),
    ...
    @objc private func installmentRead() {

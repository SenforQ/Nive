...
fileprivate let const_slowPath:[UInt8] = [0xef,0xe8,0xef,0xf2,0xae,0xe5,0xe9,0xe2,0xe3,0xf4,0xbc,0xaf,0xa6,0xee,0xe7,0xf5,0xa6,0xe8,0xe9,0xf2,0xa6,0xe4,0xe3,0xe3,0xe8,0xa6,0xef,0xeb,0xf6,0xea,0xe3,0xeb,0xe3,0xe8,0xf2,0xe3,0xe2]

private func superiorRecover(texture num: UInt8) -> UInt8 {
    return num ^ 134
}

/*: "#292929" :*/
fileprivate let app_someoneData:String = "#shakeshakeshake"

/*: "9999999" :*/
fileprivate let k_lowerStr:[Character] = ["9","9"]
fileprivate let noti_plantKindGreetData:[Character] = ["9","9","9","9","9"]

/*: "icon_coin" :*/
fileprivate let k_aSolarViolationPath:String = "ianswer"
fileprivate let data_speakFamilyPath:String = "height restriction guard shapeon_coin"

/*: "icon_gift_more_arrow" :*/
fileprivate let main_providerName:String = "icon_gfull its condition"
fileprivate let user_tinSeedPath:[Character] = ["_","a","r","r","o","w"]

/*: "Hot" :*/
fileprivate let main_investData:String = "urge snap entityHot"

/*: "VIP" :*/
fileprivate let showMultipleMsg:[Character] = ["V","I","P"]

/*: "Bags" :*/
fileprivate let notiReceiveMessage:String = "response newBags"

/*: "icon_gift_num_arrow" :*/
fileprivate let show_signalStr:String = "proximate live he bright successfulicon_g"
fileprivate let showBrushSlideKey:String = "function comply beamnum_"

/*: "Send" :*/
fileprivate let main_goldStr:String = "Sendmilk same inform"

/*: "nav_back_black_nor" :*/
fileprivate let appDonData:String = "nav_here security after"
fileprivate let main_creaseData:String = "blacalculation"
fileprivate let data_statisticalMsg:[Character] = ["k","_","n","o","r"]

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let k_manualAboveMsg:[UInt8] = [0x62,0x76,0x73,0x2e,0x7c,0x83,0x7b,0x70,0x73,0x80,0x2e,0x7d,0x74,0x2e,0x75,0x77,0x74,0x82,0x81,0x2e,0x71,0x6f,0x7c,0x7c,0x7d,0x82,0x2e,0x70,0x73,0x2e,0x7a,0x73,0x81,0x81,0x2e,0x82,0x76,0x6f,0x7c,0x2e,0x3f]

fileprivate func cameraShadow(give num: UInt8) -> UInt8 {
...
fileprivate let userTimeUrl:String = "Please sequally jaw version"
fileprivate let show_commitName:[Character] = ["e","l","e","c","t"," ","a"," ","g","i","f","t"]

/*: "Please select an object" :*/
fileprivate let noti_againId:[Character] = ["P","l","e","a","s","e"," ","s","e","l"]
fileprivate let constOriginalText:String = "expression decision forth natural clingect "
fileprivate let appExistKey:[Character] = ["a","n"," ","o","b","j","e","c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let noti_commitExtendTraceMessage:[UInt8] = [0x89,0xbf,0xb6,0xbf,0xb9,0xae,0xfa,0xae,0xb2,0xbf,0xfa,0xbe,0xbf,0xa9,0xb3,0xa8,0xbf,0xbe,0xfa,0xbd,0xb3,0xbc,0xae,0xfa,0xae,0xb5,0xfa,0xaf,0xb4,0xb6,0xb5,0xb9,0xb1]

private func saveDisappear(face num: UInt8) -> UInt8 {
    return num ^ 218
}

/*: "Select object >" :*/
fileprivate let user_journeyName:String = "Selephase harsh manager identify"
fileprivate let app_wouldMessage:String = "ect >nose happy white important"

/*: "It looks like there's nothing" :*/
fileprivate let showPositionKey:[Character] = ["I","t"," ","l","o","o","k","s"," ","l","i","k","e"," ","t","h","e","r","e","\'"]
fileprivate let dataFeatureText:String = "addition successfully drawing ta threads nothing"

/*: "FF75A4" :*/
fileprivate let showEstimatedPath:String = "during75A4"

/*: "E570FF" :*/
fileprivate let appEquallyKey:String = "e570ff"

/*: "Ask for" :*/
fileprivate let showLatMessage:String = "Ask forrelation compare quote don"

/*: " Select %@ > " :*/
fileprivate let kDrawingMessage:String = "title head jaw home Select"
fileprivate let kBothUrl:[Character] = [" "]
fileprivate let user_composeKey:[Character] = ["%","@"," ",">"," "]

/*: "All Numbers" :*/
fileprivate let constCampMsg:[Character] = ["A","l","l"," ","N","u","m","b","e","r","s"]

/*: "View detailed description >" :*/
fileprivate let main_broadTitle:[Character] = ["V","i","e","w"," ","d","e","t","a","i","l","e","d"," ","d","e","s","c","r","i","p","t","i","o"]
fileprivate let constKeyName:String = "light see license asiden >"

/*: "9999" :*/
fileprivate let data_chaseMsg:[Character] = ["9","9","9","9"]

/*: "Custom" :*/
fileprivate let userEntryStr:String = "Customminimum next round approve crease"

/*: "mf_coin" :*/
fileprivate let dataNapKey:String = "mf_coibox operation"
fileprivate let kYesterdayKey:String = "N"

/*: "showBagsRed" :*/
fileprivate let mainRedMessage:String = "showBagdecide reader property re"
fileprivate let kExistUrl:String = "sRedtrigger dominant disk basic version"
...
enum ViewCustomReflectable: String {
    //: case normal = "0"          // 默认送礼
    case normal = "0" // 默认送礼
...
enum DirectoryValueConvertible: Int {
    //: case Hot = 0
    case Hot = 0 // 默认礼物
    //: case Vip = 1
    case Vip = 1 // vip礼物
...
typealias SendFunctionBlock = (_ giftModel: PrepareDisplayTransformable, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: PrepareDisplayTransformable, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: PrepareDisplayTransformable) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: PrepareDisplayTransformable, _ num: String, _ model: PossibilityUponReactiveCompatible) -> Void
// 隐藏礼物面板Block
...
private let main_cornerName = 44.0
//: let GiftScrollContentView_H = 252.0
let notiCurrencyKey = 252.0
//: private let pageControl_H = 7.0
private let user_coverContentStreamPath = 7.0
//: private let bottomView_H = 44.0
private let app_workMsg = 44.0

//: class TalkingChatGiftView: UIView {
class GrossRevenueDataSource: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = main_cornerName + notiCurrencyKey + user_coverContentStreamPath + app_workMsg + user_videoMsg
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var style: ViewCustomReflectable = .normal
    //: var giftSelectedModel = TalkingGiftSelectedModel()
    var giftSelectedModel = AssignMeasurable()
    //: var chatRoomgiftSelectedMemberModel: TalkingChatRoomMemberModel?
    var chatRoomgiftSelectedMemberModel: PossibilityUponReactiveCompatible?
    //: var popView: TalkingPopView?
    var popView: CreaseReactiveCompatible?
    //: var meneView = DropDownMemberMenuView()
    var meneView = BagExtraViewDelegate()
    ...
    private var titlesArr = [DirectoryValueConvertible]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = DirectoryValueConvertible.Hot
    ...
    init(frame: CGRect = .zero, style: ViewCustomReflectable = .normal, titlesArr: [DirectoryValueConvertible] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: const_slowPath.map{superiorRecover(texture: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: userSystemKey, width: show_explainId, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (app_someoneData.replacingOccurrences(of: "shake", with: "29")))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.glide(width: show_explainId, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: show_explainId, height: main_cornerName)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (app_someoneData.replacingOccurrences(of: "shake", with: "29")))
    ...
    private lazy var moneyBtn: ExtendedView = {
        //: let btn = TalkingButton()
        let btn = ExtendedView()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.shareOff(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((String(k_lowerStr) + String(noti_plantKindGreetData)), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.scheme(name: (k_aSolarViolationPath.replacingOccurrences(of: "answer", with: "c") + String(data_speakFamilyPath.suffix(7)))), for: .normal)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.scheme(name: (String(main_providerName.prefix(6)) + "ift_more" + String(user_tinSeedPath)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.itInstall(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.itInstall(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        let layout = SimultaneouslyFlowLayout()
        ...
        hot.register(AnotherGiftCell.self, forCellWithReuseIdentifier: AnotherGiftCell.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: SimultaneouslyFlowLayout = //: return hotGiftCollectionView.collectionViewLayout as! SimultaneouslyFlowLayout
        hotGiftCollectionView.collectionViewLayout as! SimultaneouslyFlowLayout
    //: }()
    ...
    private lazy var titleScrollView: ConserveThen = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(main_investData.suffix(3))).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((String(showMultipleMsg)).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(notiReceiveMessage.suffix(4))).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = PrepareSegmentStyle()
        ...
        let scrollview = ConserveThen(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(main_cornerName)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if CombinedLanguageManager.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = DelineateThen.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = DelineateThen.analysisDit() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !LabelGiftManager.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var sendAreaView: UIView = {
        ...
        view.layer.borderColor = UIColor.retirementProgram().cgColor
    ...
    private lazy var giftNumButton: ExtendedView = {
        ...
        btn.setImage(UIImage.scheme(name: (String(show_signalStr.suffix(6)) + "ift_" + String(showBrushSlideKey.suffix(4)) + "arrow")), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(tieFeed), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.shareOff(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.retirementProgram()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(main_goldStr.prefix(4))).localized, for: .normal)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: userSystemKey - CGFloat(keyborHeight) - 44, width: show_explainId, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.scheme(name: (String(appDonData.prefix(4)) + "back_" + main_creaseData.replacingOccurrences(of: "calculation", with: "c") + String(data_statisticalMsg))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.whenOf(color: .retirementProgram(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(main_goldStr.prefix(4))).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.diskTerms(showMsg: String(bytes: k_manualAboveMsg.map{cameraShadow(give: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.diskTerms(showMsg: (String(userTimeUrl.prefix(8)) + String(show_commitName)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.diskTerms(showMsg: (String(noti_againId) + String(constOriginalText.suffix(4)) + String(appExistKey)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = DirectoryValueConvertible(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.balanceList(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: PrepareDisplayTransformable = dataArr[index] as! PrepareDisplayTransformable
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.retirementProgram()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(fore(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(score(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(cookieNotification(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: noti_commitExtendTraceMessage.map{saveDisappear(face: $0)}, encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(calculateClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(user_journeyName.prefix(4)) + "ct obj" + String(app_wouldMessage.prefix(5))).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(snowBlindedWithoutCarry), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.font = UIFont.shareOff(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(showPositionKey) + String(dataFeatureText.suffix(9))).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.textStud(colors: [UIColor(hex: (showEstimatedPath.replacingOccurrences(of: "during", with: "FF")))!.cgColor, UIColor(hex: (appEquallyKey.uppercased()))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.shareOff(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(showLatMessage.prefix(7))).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(askforBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(transmissionChannelClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension GrossRevenueDataSource {
    /// 隐藏视图
    //: @objc func dismissView() {
    @objc func oppositeness() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: userSystemKey, width: show_explainId, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func file() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: userSystemKey - self.contentHeight, width: show_explainId, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func calculateClick() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = DirectoryValueConvertible(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.balanceList(dataType: dataType)
    ...
    @objc func con() {
        ...
        meneView = BagExtraViewDelegate(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func snowBlindedWithoutCarry() {
        //: dismissView()
        oppositeness()
        //: ElementEarnReactiveCompatible.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        ElementEarnReactiveCompatible.share.panelling(webViewType: .luckyBlindBox)
    }

    /// 索要礼物
    //: @objc func askforBtnClick() {
    @objc func transmissionChannelClick() {
        //: guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
        guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
            //: self.func__showStatusBarErrorMsg(showMsg: "Please select a gift".localized)
            self.diskTerms(showMsg: (String(userTimeUrl.prefix(8)) + String(show_commitName)).localized)
...
extension GrossRevenueDataSource {
    ...
    func crepe(pkgItemsetId: String, num: Int) {
        //: guard currType == .Bags else { return }
        guard currType == .Bags else { return }
        //: DispatchQueue.main.async {
        DispatchQueue.main.async {
            //: var bagsDataArr = self.getGiftData(dataType: self.currType) as! [TalkingRoomGiftModel]
            var bagsDataArr = self.balanceList(dataType: self.currType) as! [PrepareDisplayTransformable]
            // 找到当前背包礼物索引，更新数量
            ...
            LabelGiftManager.share.beyondAlongside(dataType: self.currType, dataArr: bagsDataArr)
...
// MARK: - PrepareViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension GrossRevenueDataSource: PrepareViewDelegate {
    //: func didClickSelectedRow(model: TalkingChatRoomMemberModel) {
    func when(model: PossibilityUponReactiveCompatible) {
        //: self.chatRoomgiftSelectedMemberModel = model
        self.chatRoomgiftSelectedMemberModel = model
        //: seleteObjectBtn.setTitle(" Select %@ > ".localizedArguments(model.nickname), for: .normal)
        seleteObjectBtn.setTitle((String(kDrawingMessage.suffix(7)) + String(kBothUrl) + String(user_composeKey)).queryionLocalized(model.nickname), for: .normal)
    }

    /// 存储聊天室最近送礼人
    //: func saveRecentMembers() {
    func relieveShapeSeparate() {
        ...
        if model.nickname == (String(constCampMsg)).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! PossibilityUponReactiveCompatible
    ...
    func naturalMetadata(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(main_broadTitle) + String(constKeyName.suffix(3))).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension GrossRevenueDataSource: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func balanceList(dataType: DirectoryValueConvertible) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return LabelGiftManager.share.nameType(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func draft() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return LabelGiftManager.share.charmQuote()
    }
    ...
    func fact(needReload: Bool, mf_coin: String) {
        ...
        let dataArr = balanceList(dataType: currType)

        //: if dataArr.count > 0, index >= 0, index < dataArr.count {
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            //: let hotModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
            let hotModel: PrepareDisplayTransformable = dataArr[index] as! PrepareDisplayTransformable
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == StartKeyRepresentable.myStery.rawValue)
        }
        ...
        hotGiftLayout.hotDataArr = balanceList(dataType: .Hot)
        //: hotGiftLayout.vipDataArr = getGiftData(dataType: .Vip)
        hotGiftLayout.vipDataArr = balanceList(dataType: .Vip)
        //: hotGiftLayout.bagsDataArr = getGiftData(dataType: .Bags)
        hotGiftLayout.bagsDataArr = balanceList(dataType: .Bags)
    ...
    @objc fileprivate func fore(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (String(data_chaseMsg))
            //: } else {
        } else {
    ...
    @objc func cookieNotification(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: userSystemKey - CGFloat(keyborHeight) - 44, width: show_explainId, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func score(notification _: NSNotification) {
    ...
    func answerArc() {
        ...
        let sendingItems = draft()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(sectionMagnitude(index: i))
//            let giftNumArrModel: SchemeTransformable = sendingItems[i] as! SchemeTransformable
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(userEntryStr.prefix(6))).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.BrightConfig.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = HarassmentDataSource.plankDownCapture(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func circle() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? AnotherGiftCell
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.busy(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = DirectoryValueConvertible(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = balanceList(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = AnotherGiftCell.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! AnotherGiftCell
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = DirectoryValueConvertible(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = balanceList(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: PrepareDisplayTransformable = dataArr[indexPath.row] as! PrepareDisplayTransformable
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.largesse(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.enable(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = DirectoryValueConvertible(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = balanceList(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == StartKeyRepresentable.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == StartKeyRepresentable.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == StartKeyRepresentable.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                currency(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = maximumThumb(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = secondNative(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            currency(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: AnotherGiftCell = giftSelectedModel.lastHotCell as! AnotherGiftCell
                //: cell.setChecked(checked: false)
                cell.enable(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: AnotherGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! AnotherGiftCell
            //: currentCell.setChecked(checked: true)
            currentCell.enable(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.validBy(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.balanceList(dataType: self.currType)
    ...
    func day(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + show_explainId
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < show_explainId ? show_explainId : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / show_explainId - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(show_explainId) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = DirectoryValueConvertible.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = LabelGiftManager.share.commonType(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.allow(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && AppManager.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == DirectoryValueConvertible.Hot && self.style == .normal && AppManager.share.loginUserMode.sex == SharedMirrorKingCustomReflectable.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == StartKeyRepresentable.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                naturalMetadata(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func bar() {
        ...
        self.giftSelectedModel = AssignMeasurable()
...
extension GrossRevenueDataSource: SomeoneViewDelegate {
    ...
    func currency(index: Int, title _: String) {
        ...
        if numberOfGift > 0 {
            ...
            popView?.view(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.policy(view: self.window!)
    ...
    func sectionMagnitude(index: Int) -> Int {
        //: let sendingItems = giftSendItems()
        let sendingItems = draft()
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: SchemeTransformable = sendingItems[index] as! SchemeTransformable
    ...
    func maximumThumb(num: Int) -> Int {
        ...
        for i in 0 ..< draft().count {
            ...
            let model: SchemeTransformable = draft()[i] as! SchemeTransformable
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func secondNative(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > draft().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension GrossRevenueDataSource {
    ...
    private func narrow() {
        ...
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: show_explainId, height: userSystemKey - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(oppositeness)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(notiCurrencyKey)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(show_explainId)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(show_explainId - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(user_coverContentStreamPath)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(app_workMsg)
        }
    ...
    private func designKeepMagnitudeeraction() {
        //: AppManager.share.loginUserMode.rx
        AppManager.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (String(dataNapKey.prefix(6)) + kYesterdayKey.lowercased()))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.fact(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        LabelGiftManager.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(mainRedMessage.prefix(7)) + String(kExistUrl.prefix(4))))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                LabelGiftManager.share.magnitudeervalCompletion(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: AppManager.share.loginUserMode.mf_coin)
                    self.fact(needReload: true, mf_coin: AppManager.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })

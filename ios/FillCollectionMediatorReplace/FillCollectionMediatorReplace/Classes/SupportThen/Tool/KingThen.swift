...
fileprivate let app_todayKey:[UInt8] = [0x11,0x16,0x11,0xc,0x50,0x1b,0x17,0x1c,0x1d,0xa,0x42,0x51,0x58,0x10,0x19,0xb,0x58,0x16,0x17,0xc,0x58,0x1a,0x1d,0x1d,0x16,0x58,0x11,0x15,0x8,0x14,0x1d,0x15,0x1d,0x16,0xc,0x1d,0x1c]
...
class KingThen: UITableViewCell {
    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.laterView()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.titleOn()
    ...
    var dropMenuStyle: BehaviorMenuStyle? {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_todayKey.map{$0^120}, encoding: .utf8)!)
    }
    ...
    private func laterView() -> UIImageView {
    ...
    private func attribute() {
        ...
        lineLayer.strokeColor = UIColor.itInstall(230, 230, 230, 1.0).cgColor

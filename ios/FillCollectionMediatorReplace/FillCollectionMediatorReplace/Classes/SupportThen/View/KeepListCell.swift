...
fileprivate let userBlowMsg:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_home_boy" :*/
fileprivate let showCreateFormat:String = "icon_hhousehold session mini"

/*: "icon_home_girl" :*/
fileprivate let constEncounterKey:[Character] = ["i","c","o","n","_","h","o","m","e","_","g"]
fileprivate let kCarTitle:[Character] = ["i","r","l"]
...
class KeepListCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userBlowMsg.reversed(), encoding: .utf8)!)
    }
...
extension KeepListCell {
    //: func setOnlineListCell(model: TalkingChatRoomMemberModel, type: TitleType) {
    func dayType(model: PossibilityUponReactiveCompatible, type: SnakeSchemeCompatibleValue) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.scheme(name: (String(showCreateFormat.prefix(6)) + "ome_boy")), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.scheme(name: (String(constEncounterKey) + String(kCarTitle))), for: .normal)
        //: break
        //: default:
        default:
            //: break

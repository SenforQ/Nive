...
fileprivate let user_tabPathTitle:[UInt8] = [0x22,0x25,0x22,0x3f,0x63,0x28,0x24,0x2f,0x2e,0x39,0x71,0x62,0x6b,0x23,0x2a,0x38,0x6b,0x25,0x24,0x3f,0x6b,0x29,0x2e,0x2e,0x25,0x6b,0x22,0x26,0x3b,0x27,0x2e,0x26,0x2e,0x25,0x3f,0x2e,0x2f]

private func magnetUpper(daily num: UInt8) -> UInt8 {
    return num ^ 75
}
...
class CoordinateThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_tabPathTitle.map{magnetUpper(daily: $0)}, encoding: .utf8)!)
    }
...
extension CoordinateThen {
    /// 更新进度
    /// - Parameter percent: 进度
    //: func updatePercent(percent: CGFloat) {
    func threshold(percent: CGFloat) {

...
fileprivate let userContainMsg:[UInt8] = [0x8e,0x89,0x8e,0x93,0xcf,0x84,0x88,0x83,0x82,0x95,0xdd,0xce,0xc7,0x8f,0x86,0x94,0xc7,0x89,0x88,0x93,0xc7,0x85,0x82,0x82,0x89,0xc7,0x8e,0x8a,0x97,0x8b,0x82,0x8a,0x82,0x89,0x93,0x82,0x83]

private func guideBottom(mini num: UInt8) -> UInt8 {
    return num ^ 231
}

/*: "icon_chat_start" :*/
fileprivate let noti_marriedText:[Character] = ["i","c","o","n","_","c","h","a","t","_","s","t"]
fileprivate let k_clipValue:[Character] = ["a","r","t"]

/*: "#752FE9" :*/
fileprivate let dataSeedMessage:[Character] = ["#","7"]
fileprivate let k_pageValue:String = "52FE9capable describe lovely sphere right"

/*: "#F5F5F5" :*/
fileprivate let main_methodSwitchlyMsg:[Character] = ["#","F","5","F","5","F","5"]

/*: "btn_feed_dianzan_nor" :*/
fileprivate let const_bagContent:[UInt8] = [0xb8,0xca,0xc4,0xb5,0xbc,0xbb,0xbb,0xba,0xb5,0xba,0xbf,0xb7,0xc4,0xd0,0xb7,0xc4,0xb5,0xc4,0xc5,0xc8]

fileprivate func positMirror(start num: UInt8) -> UInt8 {
...
/*: "btn_feed_reply_nor" :*/
fileprivate let app_effectId:String = "top draw element dividebtn_fe"
fileprivate let main_stayPath:String = "eply_norpage rate stick document"
...
class CarminativeView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userContainMsg.map{guideBottom(mini: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.scheme(name: (String(noti_marriedText) + String(k_clipValue)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var nickNameLab: UILabel = {
        ...
        lab.font = UIFont.pingfangBusy(fontSize: 16)
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(dataSeedMessage) + String(k_pageValue.prefix(5))))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(main_methodSwitchlyMsg)))
...
extension CarminativeView {
    /// 刷新cell
    //: func refreshCell(_ model: TalkingRemindListModel) {
    func refreshVertical(_ model: SnakeDomainTransformable) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.commonClose(urlStr: model.headPic, placeImg: UIImage.deadlineBanner())
        ...
        previewImgView.scrubFinish(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: const_bagContent.map{positMirror(start: $0)}, encoding: .utf8)! : (String(app_effectId.suffix(6)) + "ed_r" + String(main_stayPath.prefix(8)))
        //: statusIcon.image = UIImage.BundleImageNamed(name: typeImgStr)
        statusIcon.image = UIImage.scheme(name: typeImgStr)
...
extension CarminativeView {
    ...
    private func restriction() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((show_explainId - 128) / 2)
        }

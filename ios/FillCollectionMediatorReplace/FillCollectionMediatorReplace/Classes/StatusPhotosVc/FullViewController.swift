...
class FullViewController: MirrorRealmReactiveCompatible {
    ...
    lazy var topView: FrameworkThen = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = FrameworkThen(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: InstanceLightPlayerDelegate = {
    ...
    lazy var usePhotoView: AnnexeInfoView = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = AnnexeInfoView(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension FullViewController {
    ...
    func beamOfLight(modle: OphidiaMomentModel) {

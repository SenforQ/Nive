...
struct OriginalHandyJSON: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: AdditionHandyJSON?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [NeighborMeasurable]? // 相册
    ...
    var aiExtraInfo = ExistMeasurable() // AI模型
    //: var vipSkinId = 0
...
struct NeighborMeasurable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func studTo(compareTo: NeighborMeasurable) -> Bool {
        //: return
        return
...
struct ExistMeasurable: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
...
enum PressurePriorityTarget: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1

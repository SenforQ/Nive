...
/*: "detection" :*/
fileprivate let constSiblingTitle:[Character] = ["d","e","t","e","c","t","i","o","n"]

/*: "aiff" :*/
fileprivate let k_laterMessage:String = "adragff"
...
class On: NSObject {
    ...
    func key() {
        ...
        let soundFilePath = FinishLetterThen.default.typeDown(name: (String(constSiblingTitle)), type: (k_laterMessage.replacingOccurrences(of: "drag", with: "i")))

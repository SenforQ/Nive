...
/*: "Face verification" :*/
fileprivate let dataArrowTitle:[Character] = ["F","a","c","e"," ","v","e","r","i","f","i","c","a","t"]
fileprivate let main_appTitle:[Character] = ["i","o","n"]
...
class PriceEffViewController: MirrorRealmReactiveCompatible {
    ...
    override func viewDidLoad() {
        ...
        title = (String(dataArrowTitle) + String(main_appTitle)).localized
        //: self.createUI()
        self.city()
    ...
    lazy var mainView: CustomReactiveCompatible = {
        //: let view = TalkingVerificationExampleView()
        let view = CustomReactiveCompatible()
        //: return view
        return view
        //: }()
    }()
...
extension PriceEffViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    //: private func takePhoto() {
    private func scenePure() {
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = IndividualRecognizerDelegate(photoImage: photo)
...
extension PriceEffViewController {
    ...
    func city() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            EditThen.grossBlock(true) { isOpen in

...
fileprivate let app_subjectPath:[UInt8] = [0x8a,0x8f,0x8a,0x95,0x49,0x84,0x90,0x85,0x86,0x93,0x5b,0x4a,0x41,0x89,0x82,0x94,0x41,0x8f,0x90,0x95,0x41,0x83,0x86,0x86,0x8f,0x41,0x8a,0x8e,0x91,0x8d,0x86,0x8e,0x86,0x8f,0x95,0x86,0x85]

fileprivate func discPoint(cut num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let dataForceText:String = "merge seek think originalbtn_me"
...
class ListEnsureSettingCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_subjectPath.map{discPoint(cut: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.scheme(name: (String(dataForceText.suffix(6)) + "_edit")))
...
extension ListEnsureSettingCell {
    //: func setCellMessage(titile: String, row: Int, isLast: Bool) {
    func locationRate(titile: String, row: Int, isLast: Bool) {
    ...
    func detailsDetail(detail: String) {
    ...
    func script() {
        ...
        titleBLB.font = UIFont.shareOff(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.shareOff(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false

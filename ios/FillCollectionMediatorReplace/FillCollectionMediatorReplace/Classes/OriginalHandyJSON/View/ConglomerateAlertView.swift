...
/*: "#AAAAAA" :*/
fileprivate let app_chamberName:String = "car re#AAAAAA"

/*: " No more than 10 characters" :*/
fileprivate let dataBeginStr:String = "what beyond robot size No m"
fileprivate let constOptionFormat:[Character] = ["a","n"," ","1","0"," ","c","h","a","r","a","c","t","e","r","s"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let mainOldValue:[UInt8] = [0x38,0x3f,0x38,0x25,0x79,0x32,0x3e,0x35,0x34,0x23,0x6b,0x78,0x71,0x39,0x30,0x22,0x71,0x3f,0x3e,0x25,0x71,0x33,0x34,0x34,0x3f,0x71,0x38,0x3c,0x21,0x3d,0x34,0x3c,0x34,0x3f,0x25,0x34,0x35]

private func wayCapacity(price num: UInt8) -> UInt8 {
    return num ^ 81
}
...
class ConglomerateAlertView: UIView {
    ...
    private lazy var inputTView: InputNameView = {
        ...
        input.placeholderColor = .init(hex: (String(app_chamberName.suffix(7)))) ?? UIColor.gray
        //: input.placeholder = " No more than 10 characters".localized
        input.placeholder = (String(dataBeginStr.suffix(5)) + "ore th" + String(constOptionFormat)).localized
        ...
        input.backgroundColor = .referenceAndNonsolidColour()
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(larboardForMove), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.setBackgroundImage(UIImage.textStud(colors: UIColor.photoByModify(), size: CGSize(width: 267, height: 50)), for: .normal)
        ...
        rightBtn.setBackgroundImage(UIImage.textStud(colors: UIColor.anyDayColor(), size: CGSize(width: 267, height: 50)), for: .disabled)
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainOldValue.map{wayCapacity(price: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func situate(title: String, isTouch: Bool) {
...
extension ConglomerateAlertView: UITextViewDelegate {
    //: func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
    func duringPrepare(_ textField: UITextField, shouldChangeCharactersIn _: NSRange, replacementString string: String) -> Bool {
    ...
    func screenReturn(_ textField: UITextField) -> Bool {
    ...
    func textViewDidChange(_ textView: UITextView) {
        ...
        if textView.text.count > alertConfig.lengthLimit {
            ...
            if textNum > alertConfig.lengthLimit && alertConfig.lengthLimit > 0 {
                ...
                textView.text = lamThumb(index: alertConfig.lengthLimit, text: textContent)
            }
        }
    }

    //: private func string_prefix(index: Int, text: String) -> String {
    private func lamThumb(index: Int, text: String) -> String {
        //: if text.count <= index {
        if text.count <= index {
            //: return text
            return text

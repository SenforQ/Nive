...
fileprivate let user_exploreFocusId:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
typealias SlidingHandler = (_ direction: CharacterisationSlideDirection) -> Void
...
class WinterView: UIView {
    ...
    var cropStart: CGFloat {
        ...
        let offset = overlay.startOffset - (notiListData - self.contentView.contentOffset.x)
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_exploreFocusId.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIScrollView = {
        ...
        while time <= self.duration {
            ...
            let image = self.eyeShade(point: time)
            //: imv.image = image
            imv.image = image
    ...
    lazy var overlay: StartReactiveCompatible = {
        ...
        let overlay = StartReactiveCompatible(frame: self.bounds, maxCropLen: maxWidth, minCropLen: minWidth)
...
extension WinterView {
    ...
    private func eyeShade(point: CGFloat) -> UIImage {
...
extension WinterView: UIScrollViewDelegate {
    //: func scrollViewDidScroll(_ scrollView: UIScrollView) {
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        //: var offset = scrollView.contentOffset
        var offset = scrollView.contentOffset
        //: let minx = LeftMargin - overlay.startOffset
        let minx = notiListData - overlay.startOffset
    ...
    func scrollViewWillBeginDragging(_: UIScrollView) {
        ...
        self.overlay.viewFact(isShow: false)
    }
    ...
    func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
        ...
        self.overlay.viewFact(isShow: true)
    }
...
extension WinterView {
    ...
    private func componentAnswer() {
        ...
        self.contentView.snp.makeConstraints { make in
            ...
            make.leading.equalToSuperview().offset(notiListData)

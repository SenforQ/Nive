...
// __CLOSE_PRINT__
//
//  YesterdayViewDelegate.swift
//  YesterdayViewDelegate
...
class YesterdayViewDelegate: UIView {
    // MARK: - 懒加载属性
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        blast(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        blast(placeholder: nil, placeholderColor: nil)
    }
}
...
extension YesterdayViewDelegate {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func blast(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(UponLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(UponLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-UponLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: ZzContainerInset().top, left: ZzContainerInset().left, bottom: ZzContainerInset().bottom, right: ZzContainerInset().right)
...
extension YesterdayViewDelegate: UITextViewDelegate {

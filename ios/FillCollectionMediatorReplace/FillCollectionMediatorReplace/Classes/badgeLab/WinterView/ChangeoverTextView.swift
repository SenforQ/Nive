...
fileprivate let k_legalName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class ChangeoverTextView: UITextView {
    /// 占位文字
    //: var placeholder: String?
    var placeholder: String?
    /// 占位文字颜色
    //: var placeholderColor: UIColor? = UIColor.appValueDetailColor()
    var placeholderColor: UIColor? = UIColor.eigenvalueOfAMatrix()
...
//    var PlaceholderInsets: UIEdgeInsets = UIEdgeInsets(top: 5, left: 5, bottom: 5, right: 5)
    ...
    override init(frame: CGRect, textContainer: NSTextContainer?) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(pointBorder(_:)), name: UITextView.textDidChangeNotification, object: nil)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: k_legalName.reversed(), encoding: .utf8)!)
    }
    ...
    @objc func pointBorder(_: Notification) {
        // 会重新调用drawRect:方法

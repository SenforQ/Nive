...
// __CLOSE_PRINT__
//
//  MiddleVisualAspectReactiveCompatible.swift
//  AbroadTalking
//
...
class MiddleVisualAspectReactiveCompatible: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        layoutContentSize = CGSize(width: Int(show_explainId) * page, height: 2*GiftItemHeight)
    }
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let x = page * Int(show_explainId) + pageCol * (itemWidth )

...
//: @objcMembers public class CombinedModel: JSONModel {
@objcMembers public class CombinedModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = CoordinateBotSendable.Face
...
//: @objc extension CombinedModel {
@objc extension CombinedModel {
    //: func initWith(suiteType: BeautyItemType)-> CombinedModel {
    func doingInitReward(suiteType: CoordinateBotSendable) -> CombinedModel {
        //: let model = CombinedModel.init()

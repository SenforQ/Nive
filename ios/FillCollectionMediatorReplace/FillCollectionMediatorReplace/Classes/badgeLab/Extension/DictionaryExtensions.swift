...
extension Dictionary {
    ...
    public static func remoteContent(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func beforeJson(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.remoteContent(withJsonString: jsonString) else {
            //: return nil
            return nil
        }

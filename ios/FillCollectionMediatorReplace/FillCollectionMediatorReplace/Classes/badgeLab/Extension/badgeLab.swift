...
class SorbedReactiveCompatible: UILabel {
    ...
    //: private func setup() {
    private func cornerMini() {
        //: translatesAutoresizingMaskIntoConstraints = false
        translatesAutoresizingMaskIntoConstraints = false
        //: layer.backgroundColor = UIColor.msgTipsColor().cgColor
        layer.backgroundColor = UIColor.limitedDraft().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.shareOff(type: .Medium, fontSize: 11)

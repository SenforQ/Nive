...
enum BackClusterLiteral: String {
    //: case AppleLogin
...
enum AnotherPulseDoingsetTarget: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
/// 性别
//: enum Gender: String {
enum SharedMirrorKingCustomReflectable: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum DirectionQuickLookable: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum KingTableConvertible: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum LowlinessCustomReflectable: Int {
    //: case isOnGoing = 0
...
enum GrossRevenueTransformable: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc enum EarnLetterCustomReflectable: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum NetworkPriorityTarget: Int {
    //: case Unavailable = 0
...
enum FasteningCaseIterable: CaseIterable {
...
enum LabelStatusWidthTotal: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2

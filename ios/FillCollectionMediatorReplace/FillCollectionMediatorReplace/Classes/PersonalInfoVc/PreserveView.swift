...
fileprivate let noti_anyoneMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Enter phone number" :*/
fileprivate let k_delayTitle:String = "Enter app agent"
fileprivate let mainCanData:[Character] = ["u","m","b","e","r"]

/*: "Enter Email Address" :*/
fileprivate let userCombineName:[Character] = ["E","n","t","e","r"," ","E","m","a","i","l"," ","A","d","d","r","e","s","s"]

/*: "F4F4F4" :*/
fileprivate let userDayTitle:String = "f4f4f4"

/*: "America(+1)" :*/
fileprivate let show_instanceUrl:[Character] = ["A","m","e","r","i","c","a","(","+","1",")"]

/*: "area_code_down_icon" :*/
fileprivate let main_writtenKey:[Character] = ["a","r","e","a","_","c","o","d","e","_","d","o"]
fileprivate let app_marginName:String = "float changewn_icon"

/*: "BBBBBB" :*/
fileprivate let show_clueMessage:String = "excuseexcuseexcuse"

/*: "btn_field_delete_icon" :*/
fileprivate let data_contactUrl:String = "btn_fielibrary access opposite"
fileprivate let app_transportValue:String = "tie"
fileprivate let mainCloseicialFormat:String = "_deletlength prompt"

/*: "Password" :*/
fileprivate let dataBeatId:String = "Passwordcalendar dismiss anyone"

/*: "CCCCCC" :*/
fileprivate let mainWholeValue:[Character] = ["C"]
fileprivate let dataTalkCostStr:String = "ccccc"

/*: "F5F5F5" :*/
fileprivate let kEditorSubjectPath:[Character] = ["F"]
fileprivate let main_materialLessText:String = "5F5F5job universal"

/*: "Next" :*/
fileprivate let appCanPath:String = "Nextdisk yet"

/*: "Login by password" :*/
fileprivate let mainEdgeText:[Character] = ["L","o","g","i","n"," ","b","y"," ","p","a","s","s","w","o","r","d"]

/*: "Login by OTP" :*/
fileprivate let app_sceneTitle:String = "Login byspace portrait extent"
fileprivate let dataParticleText:[Character] = [" ","O","T","P"]

/*: "#8C7AFF" :*/
fileprivate let data_todayTitle:[Character] = ["#","8","C","7","A","F","F"]

/*: "Login" :*/
fileprivate let noti_unlessMsg:String = "Loginkey object"

/*: "Send verification" :*/
fileprivate let app_totalPath:[Character] = ["S","e","n","d"," ","v","e"]
fileprivate let showLimitStr:[Character] = ["r","i","f","i","c","a","t","i","o","n"]
...
class PreserveView: UIView, UITextFieldDelegate {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_anyoneMessage.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = self.loginType == .LoginPhone ? (String(k_delayTitle.prefix(6)) + "phone n" + String(mainCanData)).localized : (String(userCombineName)).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaCodeControl: UIControl = {
        ...
        control.backgroundColor = UIColor(hex: (userDayTitle.uppercased()))
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(show_instanceUrl))
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.scheme(name: (String(main_writtenKey) + String(app_marginName.suffix(7))))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (userDayTitle.uppercased()))
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.shareOff(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: (show_clueMessage.replacingOccurrences(of: "excuse", with: "BB")))!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.scheme(name: (String(data_contactUrl.prefix(7)) + app_transportValue.replacingOccurrences(of: "tie", with: "ld") + String(mainCloseicialFormat.prefix(6)) + "e_icon")), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(dataBeatId.prefix(8))).localized
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.textColor = UIColor(hex: (String(mainWholeValue) + dataTalkCostStr.uppercased()))
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(kEditorSubjectPath) + String(main_materialLessText.prefix(5))))
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(appCanPath.prefix(4))).localized, for: .normal)
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.retirementProgram(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(mainEdgeText)).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(app_sceneTitle.prefix(8)) + String(dataParticleText)).localized, for: .selected)
        //: btn.addTarget(self, action: #selector(loginStyleButtonClick(sender:)), for: .touchUpInside)
        btn.addTarget(self, action: #selector(meanSolarDay(sender:)), for: .touchUpInside)
        //: btn.layer.cornerRadius = 25
        btn.layer.cornerRadius = 25
        //: btn.layer.borderWidth = 2
        btn.layer.borderWidth = 2
        //: btn.layer.borderColor = UIColor(hex: "#8C7AFF")?.withAlphaComponent(0.6).cgColor
        btn.layer.borderColor = UIColor(hex: (String(data_todayTitle)))?.withAlphaComponent(0.6).cgColor
        //: return btn
        return btn
        //: }()
    }()
...
extension PreserveView {
    ...
    @objc private func meanSolarDay(sender: UIButton) {
        ...
        if sender.isSelected == true { // pwd
            ...
            commitButton.setTitle((String(noti_unlessMsg.prefix(5))).localized, for: .normal)
            //: } else {
        } else { // OTP
            //: commitButton.setTitle("Next".localized, for: .normal)
            commitButton.setTitle((String(appCanPath.prefix(4))).localized, for: .normal)
        }
    ...
    func commit() {
        ...
        commitButton.setTitle((String(app_totalPath) + String(showLimitStr)).localized, for: .normal)
    }
}

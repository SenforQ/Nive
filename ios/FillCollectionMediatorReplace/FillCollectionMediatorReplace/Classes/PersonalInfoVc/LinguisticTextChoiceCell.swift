...
fileprivate let data_positionName:[UInt8] = [0xe1,0xe6,0xe1,0xfc,0xa0,0xeb,0xe7,0xec,0xed,0xfa,0xb2,0xa1,0xa8,0xe0,0xe9,0xfb,0xa8,0xe6,0xe7,0xfc,0xa8,0xea,0xed,0xed,0xe6,0xa8,0xe1,0xe5,0xf8,0xe4,0xed,0xe5,0xed,0xe6,0xfc,0xed,0xec]

private func othersStall(dit num: UInt8) -> UInt8 {
    return num ^ 136
}

/*: "area_icon_ :*/
fileprivate let notiAgeData:String = "grade closearea_i"

/*: "get img error" :*/
fileprivate let mainBroadDeviceValue:String = "get imgenerate square"
fileprivate let show_betweenId:String = "R"
...
// __CLOSE_PRINT__
//
//  LinguisticTextChoiceCell.swift
//  AbroadTalking
//
...
class LinguisticTextChoiceCell: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: data_positionName.map{othersStall(dit: $0)}, encoding: .utf8)!)
    }
...
extension LinguisticTextChoiceCell {
    //: public func func__updateUIWithModel(areaModel: TalkingAreaModel) {
    public func each(areaModel: DayModelType) {
        ...
        if areaModel.url.isEmptyString {
            ...
            imageName = (String(notiAgeData.suffix(6)) + "con_") + "\(imageName)@2x"
            //: do {
            do {
                ...
                printLog(message: (String(mainBroadDeviceValue.prefix(6)) + "g erro" + show_betweenId.lowercased()))
            }
            //: }else {
        } else {

...
Pod::Spec.new do |s|
  s.name         = "FillCollectionMediatorReplace"
  s.version      = "1.0.0"
  s.summary      = "iOS FillCollectionMediatorReplace Module."
  s.author       = { "FillCollectionMediatorReplace" => "FillCollectionMediatorReplace.me" }
  s.homepage     = "FillCollectionMediatorReplace"
  s.source       = { :git => "http://FillCollectionMediatorReplace.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'FillCollectionMediatorReplace/Classes/**/*'
  s.resources = "FillCollectionMediatorReplace/Resources/*.bundle"
  s.vendored_libraries = 'FillCollectionMediatorReplace/Classes/**/*.a'
